...
require(['json', 'jquery', 'use!underscore', 'use!backbone', 'use!backbonecache', 'use!manipulation', 'log', 'app'], function(Json, $, _, Backbone, BackboneCache, Manipulation, Log, App) {
  window.debug = true;
