...
factory = function($) {
  ...
  Snag = (function() {
    ...
    Snag.prototype.mouseDown = function(e) {
      if (this.dragEl != null) return false;
    };
      ...
      return $(document).on('rescan:snag', function(e) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          $(selector).each(function() {
            var _ref2, _ref3;
            if (typeof ((_ref2 = $(this)) != null ? (_ref3 = _ref2.data('drag-context')) != null ? _ref3.removeHandlers : void 0 : void 0) === 'function') {
  ...
  DraggableItem = (function() {
    ...
    DraggableItem.prototype.endDrag = function(e, el) {
      ...
      di = this;
      this.dragging = false;
      $(document).off('mouseup.snag.item.' + this.uid);
      ...
      if (this.addedDraggingClassCounter < 3) $(el).trigger('click');
    ...
    DraggableItem.prototype.updateDrag = function(e, el) {
      ...
      if (this.addedDraggingClassCounter > 1) $(el).addClass('dragging');
      if (this.addedDraggingClassCounter <= 3) {
    ...
    DraggableItem.prototype.tweakMouseMoveEvent = function(e) {
      ...
      if (e.which === 1 && !leftButtonDown) return e.which = 0;
    };
  ...
  DroppableTarget = (function() {
    ...
    DroppableTarget.prototype.enter = function(e, el) {
      if (!this.isMaxed()) return this.ddList.dropTargetParent = this.el;
    };
